        ...
        <Grid.Row columns={16}>
          <Grid.Column textAlign="center" computer={8} mobile={16}>
            <Card fluid={true}>
              ...
              <Card.Content extra={true}>
                <List divided={true} relaxed={true} className="finished-bets">
                        ...
                        <List.Header>
                          <div className="hometeam">
                            ...
                            <div className="team-image">
                              <Image
                                src={finishedBet.Match.HomeTeam.CrestUrl ?
                                  finishedBet.Match.HomeTeam.CrestUrl
                          ...
                          <div className="awayteam">
                            <div className="team-image">
                              <Image
                                src={finishedBet.Match.AwayTeam.CrestUrl ?
                                  finishedBet.Match.AwayTeam.CrestUrl
                          ...
                          <div className="whiteColor tags">
                            ...
                            && (
                              <div>
                                <span> | </span>
                                <Label
                                  className={finishedBet.Multiply === 10 ? 'legendaryLabel' : ''
          ...
          <Grid.Column textAlign="center" computer={8} mobile={16}>
            <Card fluid={true}>
              ...
              <Card.Content extra={true}>
                <List divided={true} relaxed={true} className="available-bets">
                      ...
                      <List.Content>
                        <List.Header>
                          <div className="hometeam">
                            ...
                            <div className="team-image">
                              <Image
                                src={availableBet.Match.HomeTeam.CrestUrl ?
                                  availableBet.Match.HomeTeam.CrestUrl
                                  : '/assets/images/hometeam-placeholder.png'}
                                onError={
                                  (e) => {
                                    e.target.onerror = null;
                          ...
                          <div className="awayteam">
                            <div className="team-image">
                              <Image
                                src={availableBet.Match.AwayTeam.CrestUrl ?
                                  availableBet.Match.AwayTeam.CrestUrl
                                  : '/assets/images/awayteam-placeholder.png'}
                                onError={
                                  (e) => {
                                    e.target.onerror = null;
                          ...
                          <div className="whiteColor tags">
                            ...
                            && (
                              <div>
                                <span> | </span>
                                <Label
                                  className={availableBet.Multiply === 10 ? 'legendaryLabel' : ''
