              ...
              <div className="betRow-info">
                  ...
                  <div className="team-image">
                    <Image
                      src={bet.Match.HomeTeam.CrestUrl ?
                        bet.Match.HomeTeam.CrestUrl : '/assets/images/hometeam-placeholder.png'}
                      onError={
                        (e: any) => {
                ...
                <div className="container-awayteam">
                  <div className="team-image">
                    <Image
                      src={
                        bet.Match.AwayTeam.CrestUrl ?
                        bet.Match.AwayTeam.CrestUrl : '/assets/images/awayteam-placeholder.png'
                      }
                      onError={
                        (e: any) => {
                          e.target.onerror = null;
