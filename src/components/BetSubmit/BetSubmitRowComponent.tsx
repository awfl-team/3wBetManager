            ...
            <div className="team-image">
              <Image
                src={match.HomeTeam.CrestUrl
                  ? match.HomeTeam.CrestUrl : '/assets/images/hometeam-placeholder.png'}
                onError={
                  (e) => {
            ...
            <div className="container-versus-details">
              <div className="home-score ">
                <Input
                  ...
                  onChange={event => this.createBet(event, match, 'home')}
                  fluid={true}
                  type="number"
                  max="9"
                  min="0"
              ...
              <div className="away-score loose">
                <Input
                  ...
                  onChange={event => this.createBet(event, match, 'away')}
                  fluid={true}
                  type="number"
                  max="9"
                  min="0"
            ...
            <div className="team-image">
              <Image
                src={match.AwayTeam.CrestUrl ?
                  match.AwayTeam.CrestUrl : '/assets/images/awayteam-placeholder.png'}
                onError={
                  (e) => {
                    e.target.onerror = null;
