...
class BetSubmitButtonComponent extends React.Component {
  ...
  render() {
    ...
    return (
      <Container fluid={true} className="submit-bets-action">
        <Modal
          trigger={(
            <Button
        ...
        >
          ...
          <Modal.Actions>
            <Button color="red" onClick={this.handleClose} inverted={true}>
              <Icon name="remove" />
                  No
            </Button>
            <Button color="green" onClick={this.handleSubmit} inverted={true}>
              <Icon name="checkmark" />
                  Yes
            </Button>
          </Modal.Actions>
