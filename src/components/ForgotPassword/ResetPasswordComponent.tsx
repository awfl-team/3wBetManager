...
class ResetPasswordComponent extends React.Component {
  ...
  componentDidMount() {
    ...
    this.setState({
      className: UserFormClassnamesHelper.getClassNamesForPassword(password,
                                                                   confirmPassword),
    });
  ...
  handleChange = (property, event) => {
    ...
    const refreshedClassName = UserFormClassnamesHelper.refreshClassNameForPassword(
      property,
      event.target.value,
      password,
      confirmPassword,
                ...
                <div className="field">
                  <div className="ui left icon input">
                    ...
                    <input
                      ...
                      className={className.isPasswordOk ?
                        'okInput' : password.length === 0 ? '' : 'errorInput'}
                    />
                  </div>
                </div>
                <div className="field">
                  <div className="ui left icon input">
                    ...
                    <input
                      ...
                      className={className.isPasswordOk ?
                        'okInput' : confirmPassword.length === 0 ? '' : 'errorInput'}
                    />
                  </div>
                </div>
                <button
